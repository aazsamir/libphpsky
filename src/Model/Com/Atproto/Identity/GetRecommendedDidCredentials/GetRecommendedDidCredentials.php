...
class GetRecommendedDidCredentials implements \Aazsamir\Libphpsky\Action
{
    ...
    public function query(): GetRecommendedDidCredentialsOutput
    {
        return \Aazsamir\Libphpsky\Model\Com\Atproto\Identity\GetRecommendedDidCredentials\GetRecommendedDidCredentialsOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
