...
class ListHosts implements \Aazsamir\Libphpsky\Action
{
    ...
    public function query(?int $limit = null, ?string $cursor = null): ListHostsOutput
    {
        return \Aazsamir\Libphpsky\Model\Com\Atproto\Sync\ListHosts\ListHostsOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
