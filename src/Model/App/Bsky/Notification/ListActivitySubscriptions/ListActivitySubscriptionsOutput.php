 ...
 * object
 */
class ListActivitySubscriptionsOutput implements \Aazsamir\Libphpsky\ATProtoObject
{
    ...
    /**
     * @param array<\Aazsamir\Libphpsky\Model\App\Bsky\Actor\Defs\ProfileView> $subscriptions
     */
    public static function new(array $subscriptions, ?string $cursor = null): self
    {
        $instance = new self();
