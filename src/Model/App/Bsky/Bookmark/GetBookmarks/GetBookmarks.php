 ...
 * query
 */
class GetBookmarks implements \Aazsamir\Libphpsky\Action
{
    ...
    {
        return \Aazsamir\Libphpsky\Model\App\Bsky\Bookmark\GetBookmarks\Output::fromArray($this->request($this->argsWithKeys(func_get_args())));
    }
