...
namespace Aazsamir\Libphpsky\Model\App\Bsky\Unspecced\GetOnboardingSuggestedUsersSkeleton;

/**
 * object
 */
class GetOnboardingSuggestedUsersSkeletonOutput implements \Aazsamir\Libphpsky\ATProtoObject
{
    use \Aazsamir\Libphpsky\Generator\Prefab\FromArray;
    use \Aazsamir\Libphpsky\Generator\Prefab\ToArray;

    public const NAME = 'output';
    public const ID = 'app.bsky.unspecced.getOnboardingSuggestedUsersSkeleton';
