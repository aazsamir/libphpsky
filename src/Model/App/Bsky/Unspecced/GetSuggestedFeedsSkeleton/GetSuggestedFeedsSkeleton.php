 ...
 * query
 */
class GetSuggestedFeedsSkeleton implements \Aazsamir\Libphpsky\Action
{
    ...
    {
        return \Aazsamir\Libphpsky\Model\App\Bsky\Unspecced\GetSuggestedFeedsSkeleton\Output::fromArray($this->request($this->argsWithKeys(func_get_args())));
    }
