...
class GetSuggestedFeeds implements \Aazsamir\Libphpsky\Action
{
    ...
    public function query(?int $limit = null): GetSuggestedFeedsOutput
    {
        return \Aazsamir\Libphpsky\Model\App\Bsky\Unspecced\GetSuggestedFeeds\GetSuggestedFeedsOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
