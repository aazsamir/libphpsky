...
class GetSuggestedOnboardingUsersSkeleton implements \Aazsamir\Libphpsky\Action
{
    ...
    public function query(
        ...
        ?int $limit = null,
    ): GetSuggestedOnboardingUsersSkeletonOutput {
        return \Aazsamir\Libphpsky\Model\App\Bsky\Unspecced\GetSuggestedOnboardingUsersSkeleton\GetSuggestedOnboardingUsersSkeletonOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
