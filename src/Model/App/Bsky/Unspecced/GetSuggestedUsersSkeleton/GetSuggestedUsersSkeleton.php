...
class GetSuggestedUsersSkeleton implements \Aazsamir\Libphpsky\Action
{
    ...
    public function query(
        ...
        return \Aazsamir\Libphpsky\Model\App\Bsky\Unspecced\GetSuggestedUsersSkeleton\GetSuggestedUsersSkeletonOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
