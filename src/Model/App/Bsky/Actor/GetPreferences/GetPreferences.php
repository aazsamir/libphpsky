...
class GetPreferences implements \Aazsamir\Libphpsky\Action
{
    ...
    {
        return \Aazsamir\Libphpsky\Model\App\Bsky\Actor\GetPreferences\GetPreferencesOutput::fromArray($this->request($this->argsWithKeys(func_get_args())), $this->typeResolver);
    }
