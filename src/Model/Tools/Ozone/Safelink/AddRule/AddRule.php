...
class AddRule implements \Aazsamir\Libphpsky\Action
{
    ...
    public function procedure(AddRuleInput $input): \Aazsamir\Libphpsky\Model\Tools\Ozone\Safelink\Defs\Event
    {
     ...
     */
    public function rawProcedure(AddRuleInput $input): array
    {
