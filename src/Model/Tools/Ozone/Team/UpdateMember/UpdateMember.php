...
class UpdateMember implements \Aazsamir\Libphpsky\Action
{
    ...
    public function procedure(UpdateMemberInput $input): \Aazsamir\Libphpsky\Model\Tools\Ozone\Team\Defs\Member
    {
     ...
     */
    public function rawProcedure(UpdateMemberInput $input): array
    {
