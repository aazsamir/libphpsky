 ...
 * object
 */
class EventGroupChatJoinRequest implements \Aazsamir\Libphpsky\ATProtoObject
{
    use \Aazsamir\Libphpsky\Generator\Prefab\FromArray;
    use \Aazsamir\Libphpsky\Generator\Prefab\ToArray;

    public const NAME = 'eventGroupChatJoinRequest';
    public const ID = 'chat.bsky.moderation.subscribeModEvents';

    /** @var string The DID of the person requesting to join. */
    ...
    /** @var string The code of the join link used to request joining. */
    ...
    /** @var bool Whether the requesting member follows the group owner. */
