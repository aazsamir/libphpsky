...
class LogEditJoinLink implements \Aazsamir\Libphpsky\ATProtoObject
{
    ...
    public const NAME = 'logEditJoinLink';
    public const ID = 'chat.bsky.convo.defs';

    public string $rev;
    public string $convoId;

    /** @var ?\Aazsamir\Libphpsky\Model\Chat\Bsky\Convo\Defs\SystemMessageView A system message with data of type #systemMessageDataEditJoinLink */
